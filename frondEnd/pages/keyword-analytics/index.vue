  ...
  <div>
    <client-only>
      ...
      <section style="padding: 60px 0px" class="section catalog" id="section-box-news">
        ...
        <KeySearch ref="keySearch" id="keySearch" />
      </section>
      <Footer />
    </client-only>
  </div>
...
import BoxTimePlayer from "../../components/frontend/keyword-analytics/BoxTimePlayerComponent.vue";
import OverallAnalytics from "../../components/frontend/keyword-analytics/OverallAnalyticsComponent.vue";
import TopKey from "../../components/frontend/keyword-analytics/TopKeyComponent.vue";
import TreeMap from "../../components/frontend/keyword-analytics/TreeMapComponent.vue";
import WordCloud from "../../components/frontend/keyword-analytics/WordCloudComponent.vue";
