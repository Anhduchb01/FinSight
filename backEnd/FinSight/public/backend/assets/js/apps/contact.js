$(document).ready(function () {
  ...
  $(".view-grid").on("click", function (event) {
    ...
    $(this)
      ...
      let btnGrid = document.querySelectorAll('.show-btn-grid')
      let btnList = document.querySelectorAll('.show-btn-list')
      for (let index = 0; index < btnGrid.length; index++) {
        btnGrid[index].setAttribute('style', 'display: block !important');
        btnList[index].setAttribute('style', 'display: none !important');
      }
  ...
  $(".view-list").on("click", function (event) {
    ...
    $(this)
      ...
      let btnList = document.querySelectorAll('.show-btn-list')
      for (let index = 0; index < btnGrid.length; index++) {
        btnGrid[index].setAttribute('style', 'display: none !important');
        btnList[index].setAttribute('style', 'display: block !important;');
        btnList[index].setAttribute('style', 'align-self: center;');
      }
  });
...
if(getPhoneInput){getPhoneInput.addEventListener("input", function () {
